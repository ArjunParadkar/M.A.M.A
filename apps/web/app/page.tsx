...
export default function Home() {
  ...
  const aiFeaturesScrollRef = useRef<HTMLDivElement>(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-200 to-white">
      ...
      <div className="bg-yellow-100 border-b-2 border-yellow-400 p-3 fixed top-0 left-0 right-0 z-[60]">
        <div className="max-w-7xl mx-auto flex items-center gap-3 flex-wrap">
          <p className="text-xs font-bold text-yellow-800">🔧 DEV MODE:</p>
          <Link href="/client/dashboard" className="bg-yellow-200 hover:bg-yellow-300 text-yellow-900 px-4 py-2 text-sm font-medium border border-yellow-400 rounded transition-colors">
            Client Dashboard
          </Link>
          <Link href="/maker/dashboard" className="bg-orange-200 hover:bg-orange-300 text-orange-900 px-4 py-2 text-sm font-medium border border-orange-400 rounded transition-colors">
            Maker Dashboard
          </Link>
        </div>
      </div>

      {/* Navigation Bar - Fixed at top (moved down to account for dev banner) */}
      <nav className="bg-[#0a1929] text-white px-4 md:px-8 py-4 fixed top-[52px] left-0 right-0 z-50">
      ...
      <div 
        ...
        style={{ 
          opacity: heroOpacity, 
          paddingTop: '132px', // 52px (dev banner) + 80px (nav bar)
      ...
      >
        <div className="max-w-7xl mx-auto px-8 py-16">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl">
            Our platform leverages advanced AI systems to ensure optimal matching, fair pricing, quality assurance, and efficient workflow management.
          </p>
          ...
          <div className="relative">
            ...
            <button
              onClick={() => {
                if (aiFeaturesScrollRef.current) {
                  aiFeaturesScrollRef.current.scrollBy({ left: -400, behavior: 'smooth' });
                }
              }}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#0a1929] text-white p-3 rounded-full shadow-lg hover:bg-[#1a2332] transition-colors border border-[#253242]"
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#0a1929] text-white p-3 rounded-full shadow-lg hover:bg-[#1a2332] transition-colors border border-[#253242]"
            ...
            >
            {/* AI #1 - Maker Ranking */}
            <div className="bg-[#0a1929] p-6 border border-[#1a2332] flex-shrink-0 w-80">
              <div className="mb-4">
            ...
            {/* AI #5 - Time Calculator */}
            <div className="bg-[#0a1929] p-6 border border-[#1a2332] flex-shrink-0 w-80">
              <div className="mb-4">
                <span className="text-[#9ca3af] text-sm font-medium">AI System #5</span>
                <h3 className="text-xl font-semibold text-white mt-2 heading-font">
                  Time Calculator
                </h3>
              </div>
              <p className="text-[#9ca3af] mb-4 leading-relaxed">
                Estimates manufacturing time based on:
              </p>
              <ul className="text-[#9ca3af] space-y-2 text-sm mb-4">
                <li>• STL file complexity</li>
                <li>• Material properties</li>
                <li>• Device capabilities</li>
                <li>• Quantity and tolerance</li>
              </ul>
              <div className="pt-4 border-t border-[#1a2332]">
                <span className="text-[#9ca3af] text-xs">Provides accurate time estimates for planning and deadlines</span>
              </div>
            </div>

            {/* AI #6 - Earnings Calculator */}
            <div className="bg-[#0a1929] p-6 border border-[#1a2332] flex-shrink-0 w-80">
              <div className="mb-4">
                <span className="text-[#9ca3af] text-sm font-medium">Business Logic</span>
                <h3 className="text-xl font-semibold text-white mt-2 heading-font">
                  Earnings Calculator
                </h3>
              </div>
              ...
              <ul className="text-[#9ca3af] space-y-2 text-sm mb-4">
                ...
                <li>• Material costs</li>
                <li>• Net profit</li>
                <li>• Earnings by job</li>
              </ul>
              <div className="pt-4 border-t border-[#1a2332]">
                <span className="text-[#9ca3af] text-xs">Automatically calculates earnings from completed jobs</span>
              </div>
            </div>

            {/* AI #7 - Next Project Recommender */}
            <div className="bg-[#0a1929] p-6 border border-[#1a2332] flex-shrink-0 w-80">
              <div className="mb-4">
                <span className="text-[#9ca3af] text-sm font-medium">Business Logic</span>
                <h3 className="text-xl font-semibold text-white mt-2 heading-font">
              ...
              <p className="text-[#9ca3af] mb-4 leading-relaxed">
                Recommends next jobs based on:
              </p>
              <ul className="text-[#9ca3af] space-y-2 text-sm mb-4">
                <li>• Material compatibility</li>
                <li>• Tolerance matching</li>
                <li>• Pay potential</li>
                <li>• Urgency and deadlines</li>
              </ul>
              <div className="pt-4 border-t border-[#1a2332]">
                <span className="text-[#9ca3af] text-xs">Helps manufacturers find the best next projects to take on</span>
              </div>
            </div>

            {/* AI #8 - Rating Aggregator */}
            <div className="bg-[#0a1929] p-6 border border-[#1a2332] flex-shrink-0 w-80">
              <div className="mb-4">
                <span className="text-[#9ca3af] text-sm font-medium">Business Logic</span>
                <h3 className="text-xl font-semibold text-white mt-2 heading-font">
              ...
              <p className="text-[#9ca3af] mb-4 leading-relaxed">
                Aggregates ratings with:
              </p>
              <ul className="text-[#9ca3af] space-y-2 text-sm mb-4">
                <li>• Average ratings</li>
                <li>• Bayesian averaging</li>
                <li>• Rating distribution</li>
                <li>• Confidence scores</li>
              </ul>
              <div className="pt-4 border-t border-[#1a2332]">
                <span className="text-[#9ca3af] text-xs">Fair rating system that prevents new users from dominating</span>
              </div>
            </div>
            </div>
          </div>
